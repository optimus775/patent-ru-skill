...
> Skill для подготовки материалов российской патентной заявки: анализ проекта, отбор технического решения, уровень техники, оценка перекрытия, описание изобретения, формула, реферат и фигуры.
...
| Оценка перекрытия | Формирует отдельный предварительный отчет о полном, частичном или не выявленном перекрытии найденными источниками |
