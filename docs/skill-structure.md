...
- `tools/` содержит детерминированные утилиты для конвертации Office, Markdown/Word, mermaid, CNIPA и журналирования итераций.
...
| `prompts/prior_art_search.md` | поиск уровня техники; CNIPA-first сохранен временно |
...
| `tools/` | `md_to_docx.py`, `docx_to_md.py`, `pptx_to_md.py`, `mermaid_render.py`, `iteration_dialog_log.py`, CNIPA-утилиты |
